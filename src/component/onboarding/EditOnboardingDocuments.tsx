...
// const OnboardingDocuments: React.FC<EditOnboardingDocumentsProps> = ({
//   onProceed,
//   onBack,
// }) => {
...
//             Upload all filled and signed documents that were attached in your
//             mail
//           </p>
//         </div>
...
//                 (e.g Contract Letter, Guarantor Form, NDA etc)
//               </span>
//             </h3>
//             <Upload.Dragger
//               name="file"
...
//                   <FileOutlined className="text-5xl absolute !mt-4  !text-green-500 !mb-4" />{" "}
//                 </div>
//                 <p className="!text-lg !font-medium text-black !mb-2">
//                   Click to upload or drag & drop your files here
//                 </p>
//                 <p className="text-sm text-gray-500">
//                   PDF, JPG or PNG (max 10 files, 10 mb each)
//                 </p>
//               </div>
//             </Upload.Dragger>
//           </div>
