    ...
    <div className="space-y-0">
      ...
      <div className=" border-1 border-b-0 border-gray-300">
        {assetLogs.map((log, index) => (
          <div
            key={log.id}
            className={`md:grid md:grid-cols-12 flex flex-col md:gap-4 gap-1.5 p-2  border-b border-gray-300  ${
